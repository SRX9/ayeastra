        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {rows.slice(0, 30).map((r) => (
              <tr key={`${r.day}:${r.key}`} className="border-t border-neutral-200 dark:border-neutral-700">
      ...
      <section className="mb-8">
        ...
        {actionMetrics.length === 0 ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {actionMetrics.map((m) => (
                <tr key={m.workosOrgId} className="border-t border-neutral-200 dark:border-neutral-700">
